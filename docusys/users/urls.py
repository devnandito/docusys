...
from docusys.users.views import show_home, login_view, logout_view, show_user, create_user, create_profile, show_profile, edit_user, delete_user, edit_profile, set_pwd, change_pwd, delete_profile
from docusys.levels.views import create_level_ajax

app_name = 'docusys.users'
